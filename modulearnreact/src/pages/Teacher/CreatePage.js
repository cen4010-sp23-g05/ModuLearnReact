  ...
  return (
    <>
      <div className="container-fluid">
        <button
          className="rounded m-1 bg-danger"
          type="button"
          onClick={OnValidInviteCode}
        >
          OnValidInviteCode
        </button>
        <button
        ...
        >
          <div className="error-message">
            {failedCode && (
              <p style={{ color: "red" }}>
                This code is invalid. Please use a different code.
              </p>
            )}{" "}
          </div>
          <input
            ...
            style={{ backgroundColor: "whitesmoke", width: "200px" }}
